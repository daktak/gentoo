...
RDEPEND="${DEPEND}"
SRC_URI="https://www.github.com/${GITHUB_USER}/${GITHUB_REPO}/archive/${GITHUB_TAG} -> ${PN}-${GITHUB_TAG}.tar.gz"
...
src_prepare() {
    epatch "${FILESDIR}/makefile-linux.patch" || die
}
...
src_install() {
	...
	cd ${S}/doc
	dodoc README.md  Tor.txt assets-attribution.txt
	doicon bitcoin_logo_doxygen.png  
}
