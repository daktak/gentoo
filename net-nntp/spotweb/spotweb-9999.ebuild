...
DESCRIPTION="Spotweb is a webbased usenet binary resource indexer based on the Spotnet protocol and development"
...
src_install() {
	webapp_src_preinst
	use mysqli && epatch "${FILESDIR}/${PN}-mysqli.patch" || die "Couldn't patch for mysqli"
